 ...
 */
class RequestAttributeWhere extends RequestAttributeAbstractUrlEncodedFilters
{
    const ATTRIBUTE = 'pipe-rat-request-attribute-where-param';
    const OPTIONS_ALLOW_DEEP_WHERES = 'allow-deep-wheres';
    ...
    public function __invoke(
        ...
        $allowDeepWheres = Options::get(
            $options,
            self::OPTIONS_ALLOW_DEEP_WHERES,
            false
        );
